...
class BST
{
    public:
        ...
        void insert(int);
        void insert(node *,node *); // HEHE dodane
        void del(int);
...
int main()
{
    ...
    while (1)
    {
		...
		cin>>choice;
        switch(choiceOption(choice))
        {
        case Zad1:
            temp = new node;
            cout<<"Enter the number to be inserted : ";
	    	cin>>temp->info;
            bst.insert(root, temp);//root, temp
            break;
        case Zad2:
            if (root == NULL)
            {
            ...
            in:cout<<"Enter the number to be deleted : ";
            cin>>num;
            bst.del(num);
            break;
        case Zad3:
...
void BST::display2(node *ptr, int level)
{
	/*
    int i;
    if (ptr != NULL)
